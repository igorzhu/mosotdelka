<!-- Modal fastorder -->
<div style="display:none; padding: 40px;" class="modal fade modal-fastorder" id="bs-fastorder<?php echo $product_id;?>" tabindex="-1" role="dialog" aria-labelledby="bs-fastorderLabel">
...
<button type="button" class="close" id="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h3 style="text-align: center;" class="modal-title" id="bs-fastorderLabel"><?php echo $text_fastorder_form_header;?></h3>
...
<h4><?php echo $text_fastorder_mail_msg_order;?>: <?php echo htmlspecialchars_decode($product_name); ?></</h4>
<p>   <?php echo $text_fastorder_mail_msg_price;?>: <strong><?php echo $symbolLeft;?></strong><strong id="total-price<?php echo $product_id;?>"><?php echo $price;?></strong><strong><?php echo $symbolRight;?></strong></p>
<small> <a href="http://tauweb.ru/products/81-pokupka-v-odin-klik-dlya-opencart-bystryj-zakaz.html" title="FastOrder Button">FastOrder</a></small>
</div>
