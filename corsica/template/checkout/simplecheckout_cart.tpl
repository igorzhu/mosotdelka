        ...
        <table class="simplecheckout-cart">
            ...
            <?php foreach ($products as $product) { ?>
                ...
                <tr>
                    ...
                    <td class="price" width="15%"><?php echo $product['price']; ?></td>
                    <td class="quantity" width="15%">
                        <div class="input-group btn-block" style="max-width: 120px;">
                    ...
                    <td class="total" width="15%"><?php echo $product['total']; ?></td>
                    <td class="remove">
